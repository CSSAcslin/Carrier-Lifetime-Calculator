...
class ImagingData:
    ...
    def create_image(cls, data_obj: Union['Data', 'ProcessedData'], *arg: str) -> 'ImagingData':
        ...
        if isinstance(data_obj, Data):
            ...
            instance.fps = data_obj.parameters['fps'] if 'fps' in data_obj.parameters else 10
            ...
            instance.fps = data_obj.out_processed['fps'] if 'fps' in data_obj.out_processed else 10
